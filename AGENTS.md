...
- Read `src/bot_todo/skill_assets/todo/SKILL.md` and use the `bot-todo` CLI with `--json` for all agent mutations; never hand-edit `TODO.md`.
- Run `bot-todo --json --root . validate` before and after task-file changes.
