...
- [x] **T016** Allow edits in the Kanban task detail modal #feature
  ...
  - Context: T010 excluded task editing. T015 moves the read-only detail view into a Tabler modal. After that lands, the modal is the only detail surface, so edits belong there rather than on a restored standalone page. Use the existing core edit contract; do not add a second mutation path. Spec: .scratch/kanban-web-frontend/spec.md Plan: .scratch/kanban-web-frontend/t016-edit-modal-plan.md ADR: docs/adr/0010-edit-open-and-review-tasks-in-the-kanban-detail-modal.md Related presentation: docs/adr/0007-serve-the-local-kanban-with-the-python-standard-library.md, docs/adr/0008-use-pinned-tabler-assets-for-the-kanban-presentation.md, and docs/adr/0009-kanban-task-detail-lives-in-a-board-modal.md Glossary: CONTEXT.md
  - Related: T015
  - Blocked by: T015
  - Outcome: completed
  - Closed: 2026-08-20

- [x] **T015** Show the Kanban task detail view in a modal #feature
